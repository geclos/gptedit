...
-- @param user_input string: The input provided by the user.
-- @param filetype string: The type of the file where the code resides (e.g., "lua").
-- @param buffer table: The buffer containing the entire content of the file.
-- @param row number: The current row position of the cursor.
-- @param selection table|nil: The selected lines in the buffer, if any.
